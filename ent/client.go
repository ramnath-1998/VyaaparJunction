...
type Client struct {
	...
	Order *OrderClient
	// Order_Item is the client for interacting with the Order_Item builders.
	Order_Item *OrderItemClient
...
func (c *Client) init() {
	...
	c.Order_Item = NewOrderItemClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		Order_Item:      NewOrderItemClient(cfg),
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.Order_Item.Intercept(interceptors...)
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *OrderItemMutation:
		return c.Order_Item.mutate(ctx, m)
...
// OrderItemClient is a client for the Order_Item schema.
type OrderItemClient struct {
	config
}

// NewOrderItemClient returns a client for the Order_Item from the given config.
func NewOrderItemClient(c config) *OrderItemClient {
	return &OrderItemClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `order_item.Hooks(f(g(h())))`.
func (c *OrderItemClient) Use(hooks ...Hook) {
	c.hooks.Order_Item = append(c.hooks.Order_Item, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `order_item.Intercept(f(g(h())))`.
func (c *OrderItemClient) Intercept(interceptors ...Interceptor) {
	c.inters.Order_Item = append(c.inters.Order_Item, interceptors...)
}

// Create returns a builder for creating a Order_Item entity.
...
// CreateBulk returns a builder for creating a bulk of Order_Item entities.
...
// Update returns an update builder for Order_Item.
...
// UpdateOne returns an update builder for the given entity.
func (c *OrderItemClient) UpdateOne(oi *Order_Item) *OrderItemUpdateOne {
	mutation := newOrderItemMutation(c.config, OpUpdateOne, withOrder_Item(oi))
...
func (c *OrderItemClient) UpdateOneID(id int) *OrderItemUpdateOne {
	mutation := newOrderItemMutation(c.config, OpUpdateOne, withOrder_ItemID(id))
	return &OrderItemUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for Order_Item.
...
// DeleteOne returns a builder for deleting the given entity.
func (c *OrderItemClient) DeleteOne(oi *Order_Item) *OrderItemDeleteOne {
	return c.DeleteOneID(oi.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *OrderItemClient) DeleteOneID(id int) *OrderItemDeleteOne {
	builder := c.Delete().Where(order_item.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &OrderItemDeleteOne{builder}
}

// Query returns a query builder for Order_Item.
...
// Get returns a Order_Item entity by its id.
func (c *OrderItemClient) Get(ctx context.Context, id int) (*Order_Item, error) {
	return c.Query().Where(order_item.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *OrderItemClient) GetX(ctx context.Context, id int) *Order_Item {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *OrderItemClient) Hooks() []Hook {
	return c.hooks.Order_Item
}

// Interceptors returns the client interceptors.
func (c *OrderItemClient) Interceptors() []Interceptor {
	return c.inters.Order_Item
}
...
func (c *OrderItemClient) mutate(ctx context.Context, m *OrderItemMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown Order_Item mutation op: %q", m.Op())
	}
}
...
func (c *ProductCategoryClient) QueryProduct(pc *ProductCategory) *ProductQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, productcategory.ProductTable, productcategory.ProductColumn),
		)
...
type (
	hooks struct {
		Order, Order_Item, Product, ProductCategory, User []ent.Hook
	}
	inters struct {
		Order, Order_Item, Product, ProductCategory, User []ent.Interceptor
	}
)
