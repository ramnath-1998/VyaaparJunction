...
// OrderItemDelete is the builder for deleting a Order_Item entity.
...
func (oid *OrderItemDelete) Where(ps ...predicate.Order_Item) *OrderItemDelete {
...
func (oid *OrderItemDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(order_item.Table, sqlgraph.NewFieldSpec(order_item.FieldID, field.TypeInt))
...
// OrderItemDeleteOne is the builder for deleting a single Order_Item entity.
type OrderItemDeleteOne struct {
	oid *OrderItemDelete
}

// Where appends a list predicates to the OrderItemDelete builder.
func (oido *OrderItemDeleteOne) Where(ps ...predicate.Order_Item) *OrderItemDeleteOne {
...
func (oido *OrderItemDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{order_item.Label}
	default:
		return nil
	}
}
